...
public class DownloadServiceForAPK extends Service
{
	...
	// 返回的安装包url
	private String apkUrl = MMloveConstants.DOWNLOADURL;
	// private String apkUrl = MyApp.downloadApkUrl;
	/* 下载包安装路径 */
	private static final String savePath = "/sdcard/mamalove/";

	private static final String saveFileName = savePath + "mamalove.apk";
	// private MyApp app;
...
//						mNotification.setAutoCancel(true).setSmallIcon(iconId).setContentTitle(contentTitle)
//								.setContentIntent(appIntent).build();
						mNotification.setContentTitle("下载完成").setContentText("文件已下载完毕");
						mNotification.build();
//						mNotification=new Notification.Builder(mContext).setContentTitle("下载完成").setContentText("文件已下载完毕").build();
//						mNotification.setLatestEventInfo(mContext, "下载完成", "文件已下载完毕", null);
						//
						serviceIsDestroy = true;
						
						//RemoteViews contentview = mNotification.contentView;
						//contentview.setTextViewText(R.id.tv_progress,"下载完毕，点击安装");
...
//		mNotification = new Notification(icon, tickerText, when);
		...
		contentView.setTextViewText(R.id.name, "妈妈爱我 正在下载...");
