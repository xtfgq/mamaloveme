...
public class UserAskActivity extends BaseActivity implements OnClickListener{
	private User user;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		user = LocalAccessor.getInstance(UserAskActivity.this).getUser();
		iniView();
		...
		{
			Toast.makeText(UserAskActivity.this, R.string.msgUninternet,
	...
	protected void iniView() {
		// TODO Auto-generated method stub
		((TextView) findViewById(R.id.txtHead)).setText("我的咨询");
...
//					                    },
					...
					if(array.getJSONObject(0).has("MessageCode")){
						...
						PrivateDortorAdapter adapter = new PrivateDortorAdapter(
								UserAskActivity.this, arrayList);
//						Toast.makeText(getApplicationContext(), myApplication.arrayListyoumeng0.size()+"", 1).show();
		...
		JsonAsyncTask_Info task = new JsonAsyncTask_Info(
				UserAskActivity.this, true, doProcess);
