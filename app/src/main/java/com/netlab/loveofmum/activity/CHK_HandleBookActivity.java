...
public class CHK_HandleBookActivity extends BaseActivity {
	private WebView web;
	@Override
	...
	protected void iniView()
	{
		...
		((TextView) findViewById(R.id.txtHead)).setText("使用手册");
		web = (WebView)findViewById(R.id.web001_layout_xuzhi);
		web.getSettings().setLayoutAlgorithm(LayoutAlgorithm.SINGLE_COLUMN);
		web.loadUrl(MMloveConstants.JE_BASE_URL+"help/manual.html");
	}
	@Override
