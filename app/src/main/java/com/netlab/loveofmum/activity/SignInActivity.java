...
public class SignInActivity extends BaseActivity implements com.netlab.loveofmum.RotateAnimation.InterpolatedTimeListener {
	private User user;
	private int Score;
...
//			0.5f,Animation.RELATIVE_TO_SELF,0.5f);
   Date dNow;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		user = LocalAccessor.getInstance(SignInActivity.this).getUser();
		iniView();
		/** 设置旋转动画 */
...
//		addNum();
	...
	private void getUserInqury() {
		...
		JsonAsyncTask_Info task = new JsonAsyncTask_Info(SignInActivity.this, true,
				doProcess);
