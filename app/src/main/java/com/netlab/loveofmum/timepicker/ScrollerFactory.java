...
public class ScrollerFactory {
	...
	private final static String DRUM_SCROLLER = "com.netlab.loveofmum.timepicker.DrumPickerScroller";
	private final static String OVER_SCROLLER="android.widget.OverScroller";
	
	private final static String MzOverScroller="com.meizu.widget.MzOverScroller";
	private final static String DRUM_SCROLLER2_3 = "com.netlab.loveofmum.timepicker.DrumPickerScroller2_3";
	private final static String DrumPickerScroller4 = "com.netlab.loveofmum.timepicker.DrumPickerScroller4";
	...
	public static IDrumPickerScroller create(ScrollView scrollView, Context context){
		...
		for(Field field : fields){
			...
			else if(field.getType().getName().equals(MzOverScroller))
			{
				name = field.getName();
				clazz = DrumPickerScroller4;
				break;
			}
		}
		if(name != null){
