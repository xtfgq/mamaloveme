...
public class ImageCycleViewScroll  extends LinearLayout {
	 ...
	 * @param context
	 */
	public ImageCycleViewScroll(Context context) {
		super(context);
	}
	 ...
	 * @param attrs
	 */
	public ImageCycleViewScroll(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	 ...
	 * @author guoqiang
	 */
	public static interface ImageCycleScrollViewListener {
