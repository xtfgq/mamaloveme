...
import com.netlab.loveofmum.utils.BlurUtil;
import com.netlab.loveofmum.utils.BulrManager;
...
public class DoctorHomeAct extends BaseActivity implements OnScrollListener,
        OnRefreshListener {
    private ImageView rlmaosha, imgleft, imgBack, imgback1;
    private ImageView head;
    private final String mPageName = "AnalyticsDoctorHome";
    private ImageLoader mImageLoader;
    private ImageView micro_thematic_btn;
    ...
    private LinearLayout llconsult, search01, search02, llhome, llone, lltwo, llmore;
    ...
    private List<Map<String, Object>> arraySubjectList = new ArrayList<Map<String, Object>>();
    ...
    int scrollY=0;
    // 咨询订单编号
    private String AskOrderID, ID1, ID2;
    private Date date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = LocalAccessor.getInstance(DoctorHomeAct.this).getUser();
        ...
        if (mIntnet != null) {
            ...
            // PicUrl = mIntnet.getStringExtra("PicUrl");

        }

        mAdapter = new TalkAbount(DoctorHomeAct.this, DoctorID);
        mListView.setAdapter(mAdapter);
        int width = Util.getScreenWidth(DoctorHomeAct.this);
    ...
    public void goChat(View v) {
        if (!hasInternetConnected()) {
            Toast.makeText(DoctorHomeAct.this, "网络数据获取失败，请检查网络设置", 1).show();
            return;
        }
        user=LocalAccessor.getInstance(DoctorHomeAct.this).getUser();
...
//			AskOrderInquiry();
            if (isLine == 0) {
                ...
                Toast.makeText(DoctorHomeAct.this, "该医生不在线，不能进行在线咨询", 1).show();
            }

        } else {
            startActivity(new Intent(DoctorHomeAct.this, LoginActivity.class));
        }
...
//			AskOrderInquiry();
    ...
    protected void iniView() {
        ...
        rlmaosha = (ImageView) findViewById(R.id.rl_maosha);
...
//		imgleft = (ImageView) findViewById(R.id.img_left);
        ...
        micro_thematic_btn = (ImageView) findViewById(R.id.micro_thematic_btn);
        ...
        //
        // header = (LinearLayout) inflater.inflate(R.layout.xlistview_header,
        // null);
        docorView = (ImageCycleView) findViewById(R.id.doctor_view);
//		ivtouming = (ImageView) findViewById(R.id.iv_touming);
    ...
    private void searchAds(String date, String showposition) {
        ...
        JsonAsyncTask_Info task = new JsonAsyncTask_Info(DoctorHomeAct.this,
                true, doProcess);
                ...
                new ImageCycleViewListener() {
                    ...
                    public void displayImage(String imageURL,
                        ...
                        try {
                            ...
                            para.width = Util.getScreenWidth(DoctorHomeAct.this);
                    ...
                    public void onImageClick(int position, View imageView,
                        ...
                        String p = mObject.get(position).get("Position")
                                .toString();
                        if (p.equals("P0005")) {
                            Intent intent = new Intent(DoctorHomeAct.this,
                                    TestWebView.class);
...
//							startActivity(i);
                            ...
                            int linkid=Integer.valueOf(ID);
                            if(linkid!=0) {
                                Intent i = new Intent(DoctorHomeAct.this, SmallTalkAct.class);
                                i.putExtra("ID", ID);
                                startActivity(i);
                            }
                            ...
                            if(linkid!=0) {
                                if (ID.equals(DoctorID)) {
                                    Toast.makeText(DoctorHomeAct.this,
                                            "您已经在当前医生首页", 1).show();
                                } else {
                                    Intent i = new Intent(DoctorHomeAct.this,
                                            DoctorHomeAct.class);
...
//							https://lovestaging.topmd.cn/html/1.html
                            ...
                            if (user.UserID == 0) {
                                Intent i = new Intent(DoctorHomeAct.this, LoginActivity.class);
                                i.putExtra("Page", "User_Set");
                                startActivityForResult(i, 1);
                            } else {
                                startActivity(new Intent(DoctorHomeAct.this, ShopWebView.class));
                            }
                        ...
                        if (PicUrl != null && !"".equals(PicUrl)) {
                            mImageLoader.displayImage(
                                    MMloveConstants.JE_BASE_URL2
                                            ...
                                            "\\", "/"), head);
//							setBackground(mImageLoader
//									.loadImageSync(MMloveConstants.JE_BASE_URL2
//											+ PicUrl.replace("~", "").replace(
//													"\\", "/")));
...
//		});
            ...
            public void onClick(View v) {
                ...
                if (user.UserID != 0) {
                    if (imgfous.getText().toString().trim().equals("已关注")) {
                        if (!hasInternetConnected()) {
                            Toast.makeText(DoctorHomeAct.this, "网络数据获取失败，请检查网络设置",
                                    1).show();
                            return;
                        }
                        if (!isFav) {
                            DialogEnsureCancelView dialogEnsureCancelView = new DialogEnsureCancelView(
                                    DoctorHomeAct.this).setDialogMsg("友情提示",
                            ...
                            DialogUtils.showSelfDialog(DoctorHomeAct.this, dialogEnsureCancelView);


                        } else {
                            Toast.makeText(DoctorHomeAct.this, "请不要重复关注", 1).show();
                        }
        ...
        txtMore.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(DoctorHomeAct.this, TopicAllAct.class);
        ...
        llhome.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(DoctorHomeAct.this, SmallTalkAct.class);
        ...
        JsonAsyncTaskOnComplete doProcess = new JsonAsyncTaskOnComplete() {
            ...
            public void processJsonObject(Object result) {
                ...
                try {
                    ...
                    if ("0".equals(array.getJSONObject(0).getString(
                            "MessageCode"))) {
                        Toast.makeText(DoctorHomeAct.this, "关注成功！", 1).show();
                        imgfous.setText("已关注");
                    } else if ("1".equals(array.getJSONObject(0).getString(
                            "MessageCode"))) {
                        Toast.makeText(
