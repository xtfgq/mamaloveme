...
public class User_FindPass2 extends BaseActivity
{
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	protected void iniView()
	{
		...
		btnOK = (Button)findViewById(R.id.btn001_layout_findpass2);
		...
		btnOK.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if(hasInternetConnected())
				{
					...
					{
						Toast.makeText(User_FindPass2.this, R.string.str001_findpass2,
								Toast.LENGTH_SHORT).show();
						return;
					}
					else if(edt002.getText().toString().trim().equals(""))
					{
						Toast.makeText(User_FindPass2.this, R.string.str002_findpass2,
								Toast.LENGTH_SHORT).show();
						return;
					}
					else if(edt001.getText().toString().length()<6||edt002.getText().toString().length()>20)
					{
						...
						Toast.makeText(User_FindPass2.this, R.string.str004_findpass2,
								Toast.LENGTH_SHORT).show();
						return;
						
						
					}else if(	edt001.getText().toString().contains(" ")){
						Toast.makeText(User_FindPass2.this, "输入内容含有非法字符",
								Toast.LENGTH_SHORT).show();
						return;
						...
						Toast.makeText(User_FindPass2.this, "输入内容含有特殊字符",
								Toast.LENGTH_SHORT).show();
						return;
					}
					else if(!edt002.getText().toString().trim().equals(edt001.getText().toString()))
					{
						Toast.makeText(User_FindPass2.this, R.string.str003_findpass2,
								Toast.LENGTH_SHORT).show();
						return;
					}
					else
				...
				{
					Toast.makeText(User_FindPass2.this, R.string.msgUninternet,
							Toast.LENGTH_SHORT).show();
				}
			}
		});
							...
							if(array.getJSONObject(0).has("MessageCode"))
							{
								for (int i = 0; i < array.length(); i++)
								{
											...
											.getString("MessageCode").equals("0"))
									{
										...
										SuccussDialog(User_FindPass2.this);
...
//												}).show();
									...
									{
										Toast.makeText(User_FindPass2.this, array.getJSONObject(0)
			...
			JsonAsyncTask_Info task = new JsonAsyncTask_Info(
					User_FindPass2.this, true, doProcess);
	...
	public void SuccussDialog(final Context context){
		...
		AlertDialog.Builder builder =new AlertDialog.Builder(User_FindPass2.this);
