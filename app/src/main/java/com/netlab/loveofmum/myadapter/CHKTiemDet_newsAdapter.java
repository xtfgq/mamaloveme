 ...
 */
public class CHKTiemDet_newsAdapter extends BaseAdapter
{
...
//	private final String				SOAP_METHODNAME2	= Constants.NewsTopicAdd;
    ...
    public CHKTiemDet_newsAdapter(Context context, List<Map<String, Object>> listData,ListView listview,ListItemClickHelp callback)
    {
...
//        if(convertView==null){
        convertView = mInflater.inflate(R.layout.item_chkdetail_list_new, null);
...
//                if(user.UserID == 0)
//                {
//                    Intent i1 = new Intent(context, User_Login.class);
