 ...
 */
public class CHK_NewPostList_Adapter extends BaseAdapter {
    ...
    public CHK_NewPostList_Adapter(Context context, List<Map<String, Object>> listData)
    {
...
//		return super.isEnabled(position);
    ...
    {
        convertView = mInflater.inflate(R.layout.layout_postlist_new, null);
