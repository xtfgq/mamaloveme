...
import com.netlab.loveofmum.NewPostList;
...
public class CHKTimeDetail_TopicAdapter extends BaseAdapter
{
	...
	public CHKTimeDetail_TopicAdapter(Context context, List<Map<String, Object>> listData,ListItemClickHelp callback)
	{
...
//		return super.isEnabled(position);
	...
	public View getView(final int position, View convertView,final ViewGroup parent)
	{
        ...
        if(convertView==null) {
			convertView = mInflater.inflate(R.layout.item_chekdetail_listt_new, null);
			holder = new ViewHolder();
			holder.txt001 = (TextView)convertView.findViewById(R.id.item_chkdetail_list_txt001);
			holder.txt002 = (TextView)convertView.findViewById(R.id.item_chkdetail_list_txt002);
			holder.txt003 = (TextView)convertView.findViewById(R.id.item_chkdetail_list_txt003);
			holder.txt004 = (TextView)convertView.findViewById(R.id.item_chkdetail_list_txt004);
			holder.txt005 = (TextView)convertView.findViewById(R.id.item_chkdetail_list_txt005);

			holder.txt006 = (TextView)convertView.findViewById(R.id.item_chkdetail_list_txt006);

			holder.txt007 = (TextView)convertView.findViewById(R.id.item_chkdetail_list_txt007);
		...
		{
			ImageLoader.getInstance().displayImage(MMloveConstants.JE_BASE_URL3 + listData.get(position).get("PictureURL").toString().replace("~", "").replace("\\", "/"), holder.img004,ImageOptions.getCHKListOptions());
		}



		holder.txt001.setText(listData.get(position).get("NickName").toString());
		holder.txt003.setText(Html.fromHtml(listData.get(position).get("TopicTitle").toString()));
		holder.txt004.setText(listData.get(position).get("GoodCount").toString());
		holder.txt005.setText(listData.get(position).get("PostsCount").toString());

		holder.txt007.setText(listData.get(position).get("CreatedDate").toString());

		final View view = convertView;
		final int num=Integer.valueOf(listData.get(position).get("PostsCount").toString());
        final int p = position;
        final int one = holder.txt004.getId();
        final int two = holder.txt005.getId();
        final int three =holder.txt006.getId();

		holder.txt004.setOnClickListener(new View.OnClickListener()
		{
		...
		holder.txt005.setOnClickListener(new View.OnClickListener()
		{
		...
		holder.txt006.setOnClickListener(new View.OnClickListener()
		{
