package com.netlab.loveofmum.widget.xlistview;
...
//        mProgressBar = (ProgressBar) mHeadView.findViewById(R.id.head_progressBar);
    ...
    public void onRefreshComplete() {
        mState = DONE;
        mLastUpdatedTextView.setText("最后更新：" +new SimpleDateFormat("HH:mm:ss").format(Calendar.getInstance().getTime()));
        mLastUpdatedTextView.setTextColor(getResources().getColor(R.color.graydanpin));
...
//            mProgressBar.setVisibility(GONE);
            ...
            mTipsTextView.setText("松开立即刷新");
            mTipsTextView.setTextColor(getResources().getColor(R.color.graydanpin));
            break;
        default:
            break;
        }
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        mLastUpdatedTextView.setText(new SimpleDateFormat("HH:mm:ss").format(Calendar.getInstance().getTime()) );
