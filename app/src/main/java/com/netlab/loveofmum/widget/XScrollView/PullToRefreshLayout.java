...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	private ImageView closeView,downCloseView;
	// 下拉的箭头
	...
	private AnimationDrawable mRefreshArrow,mLoadAnima;
...
//			loadStateImageView.setVisibility(View.GONE);
			downCloseView.setVisibility(View.VISIBLE);
...
//			pullUpView.startAnimation(rotateAnimation);
		...
		case LOADING:
			// 正在加载状态
			downCloseView.setVisibility(View.GONE);
			pullUpView.setVisibility(View.VISIBLE);
			mLoadAnima.start();
//			pullUpView.clearAnimation();
...
//			loadingView.startAnimation(refreshingAnimation);
	...
	private void initView()
	{
		...
		closeView=(ImageView) refreshView.findViewById(com.netlab.loveofmum.R.id.pull_iv);
		pullView.setBackgroundResource(com.netlab.loveofmum.R.drawable.loading_anim);
		mRefreshArrow= (AnimationDrawable) pullView.getBackground();
//		refreshStateImageView = refreshView.findViewById(R.id.state_iv);
		...
		downCloseView=(ImageView) loadmoreView.findViewById(R.id.loadstate_iv);
		pullUpView.setBackgroundResource(com.netlab.loveofmum.R.drawable.loading_anim);
		mLoadAnima= (AnimationDrawable) pullUpView.getBackground();
