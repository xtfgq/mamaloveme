...
public class DialogAddEnsure extends MyDialogView {
	private TextView mTextTitle, mTextMsg, mTextEnsure;
	private LinearLayout mLayoutEnsure;
	private OnClickListener mClickListener;
	public DialogAddEnsure(Context context) {
		super(context);
		initView();
	}

	public DialogAddEnsure(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	private void initView() {
		...
		LinearLayout layout = (LinearLayout) LayoutInflater.from(context)
				.inflate(R.layout.dialog_add_jifen, this, false);
	 ...
	 * 确定按钮点击事件
	 */
	public DialogAddEnsure setOnClickListenerEnsure(OnClickListener clickListener) {
	 ...
	 * dialog信息
	 */
	public DialogAddEnsure setDialogMsg(String title, String msg, String ensure) {
