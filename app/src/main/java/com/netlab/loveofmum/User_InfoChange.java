...
public class User_InfoChange extends BaseActivity implements View.OnClickListener
{
	private TextView txtHead,txtYuchan;
	...
	private EditText edjiuzhen;
	
	private EditText edt0001_userinfochange;
	
	private EditText edt004;
	
	private String returnvalue001;
	
	private LinearLayout linear001_userphoto;
	private RelativeLayout llyuchan;
	private String RealName;
	private String UserNO;
	private String UserSex;
	private String City = "郑州";
	private String UserAge;
	private CustomerSpinner txt002;
	...
	public static final String ACCOUNT_MAINTRANCE_ICON_CACHE = "share/";
	private static final String IMGPATH = ACCOUNT_DIR;

	private static final String IMAGE_FILE_NAME = "faceImage.jpeg";
	private static final String TMP_IMAGE_FILE_NAME = "tmp_faceImage.jpeg";
	
	private CircularImage img001;
	private User user;
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	protected void iniView()
	{
		...
		img001 = (CircularImage)findViewById(R.id.img_userphoto);

		txtHead.setText("个人信息设置");
		
		linear = (LinearLayout)findViewById(R.id.linear_user_infochange);
		
		linear001_userphoto = (LinearLayout)findViewById(R.id.linear001_userphoto);
		
		btnChange = (Button)findViewById(R.id.btn01_userinfocation);
		
		edt001 = (EditText)findViewById(R.id.name_title_bar10);
		edt002 = (EditText)findViewById(R.id.id_title_bar11);
		...
		edt0001_userinfochange = (EditText)findViewById(R.id.edt0001_userinfochange);
		
		edt004 = (EditText)findViewById(R.id.txt01_userinfochange);

		llyuchan=(RelativeLayout) findViewById(R.id.llyuchan);
		txt002 = (CustomerSpinner)findViewById(R.id.txthosselect_user_set);
		edjiuzhen=(EditText)findViewById(R.id.id_title_jiuzhen);
	...
	private void setListeners()
	{
		...
		linear001_userphoto.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				// TODO Auto-generated method stub
				  if (!hasInternetConnected()){
						Toast.makeText(User_InfoChange.this, "网络数据获取失败，请检查网络设置", 1).show();
						return;
						}
				showPicturePicker(User_InfoChange.this, true);
			}
		});
		...
		linear.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				Intent i = new Intent(User_InfoChange.this, User_AuthChange.class);
				startActivity(i);
			}
		});
		llyuchan.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				Intent i = new Intent(User_InfoChange.this, TimeSet.class);
				startActivity(i);
			}
		});
		...
		btnChange.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if(hasInternetConnected())
				{
					...
					{
						Toast.makeText(User_InfoChange.this, R.string.str003_userinfochange,
								Toast.LENGTH_SHORT).show();
						return;
					}
					else
					{
						if(!IOUtils.isName(edt001.getText().toString().trim()))
						{
							Toast.makeText(User_InfoChange.this, R.string.str007_userinfochange,
									Toast.LENGTH_SHORT).show();
							return;
						}
						else
						{
							RealName = edt001.getText().toString().trim();
						}
					}
					if(edt002.getText().toString().trim().equals(""))
					{
						Toast.makeText(User_InfoChange.this, R.string.str004_userinfochange,
								Toast.LENGTH_SHORT).show();
						return;
					}
					else
					{
						if(!IOUtils.isUserNO(edt002.getText().toString().trim()))
						{
							Toast.makeText(User_InfoChange.this, R.string.str007_register,
									Toast.LENGTH_SHORT).show();
							return;
						}
						else
						{
							UserNO = edt002.getText().toString().trim();
						}
					}
					if(edt0001_userinfochange.getText().toString().trim().length()>20){
						Toast.makeText(User_InfoChange.this, "昵称不能超过20个字符",
								Toast.LENGTH_SHORT).show();
						return;
					}
					
					if(edt0001_userinfochange.getText().toString().trim().equals(""))
					{
						Toast.makeText(User_InfoChange.this, R.string.str005_userinfochange,
								Toast.LENGTH_SHORT).show();
						return;
					}
					else
					{
						NickName = edt0001_userinfochange.getText().toString().trim();
					}
					
					UserSex = "01";
					
					int radioButtonId = group.getCheckedRadioButtonId();
					RadioButton rb = (RadioButton)User_InfoChange.this.findViewById(radioButtonId);
					...
					{
						if(!IOUtils.isBeyondAge(Integer.parseInt(edt004.getText().toString().trim())))
						{
							Toast.makeText(User_InfoChange.this, R.string.str008_register,
									Toast.LENGTH_SHORT).show();
							return;
						}
						else
						{
							UserAge = edt004.getText().toString().trim();
						}
					}
					else
					{
						Toast.makeText(User_InfoChange.this, R.string.str006_userinfochange,
								Toast.LENGTH_SHORT).show();
						return;
					}
					//NickName = edt0001_userinfochange.getText().toString().trim();
//					User user = LocalAccessor.getInstance(User_InfoChange.this).getUser();
...
//					user.NickName = NickName;
				...
				{
					Toast.makeText(User_InfoChange.this, R.string.msgUninternet,
							Toast.LENGTH_SHORT).show();
				}
			}
		});
	...
	private void selectHos() {
		...
		txt002.setAdapter(adapter);
		txt002.setPosition(isDefault);
		txt002.setSelection(isDefault,true);
		if(taginfo.equals("info")){
			txt002.setEnabled(false);

			return;}
		txt002.setOnItemSelectedListener(new OnItemSelectedListener()
		{
			@Override
					...
					int position, long id)
			{
				...
				else
				{
					...
					try
					{
						LocalAccessor.getInstance(User_InfoChange.this).updateUser(user);
	...
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		user=LocalAccessor.getInstance(User_InfoChange.this).getUser();
	...
	private void UserInquiry()
	{
		try
		{
				...
				public void processJsonObject(Object result)
				{
					...
					else
					{
						...
						try
						{
							...
							{
								edt001.setText(array.getJSONObject(i)
										.getString("RealName"));
								
								edt002.setText(array.getJSONObject(i)
										.getString("UserNO"));
								
								edt0001_userinfochange.setText(array.getJSONObject(i)
										.getString("NickName"));

									edjiuzhen.setText(array.getJSONObject(i)
								...
								{
									edt004.setText(array.getJSONObject(i)
											.getString("UserAge"));
								}
								...
								{
									img001.setImageResource(R.drawable.icon_user_normal);
								}
								else
								{
									ImageLoader.getInstance().displayImage(MMloveConstants.JE_BASE_URL3 + array.getJSONObject(i)
												.getString("PictureURL").toString().replace("~", "").replace("\\", "/"), img001);
			...
			JsonAsyncTask_Info task = new JsonAsyncTask_Info(
					User_InfoChange.this, true, doProcess);
	...
	private void UserInfoChange()
	{
		try
		{
				...
				public void processJsonObject(Object result)
				{
					...
					else
					{
						...
						try
						{
							...
							{
								Toast.makeText(User_InfoChange.this, R.string.str002_userinfochange,
										Toast.LENGTH_SHORT).show();
							}
			...
			str = String.format(str, new Object[]
			{String.valueOf(user.UserID),"","","",UserNO,RealName,"",UserSex,"","",City,"",NickName,UserAge,edjiuzhen.getText().toString()});
				...
				public void processJsonObject(Object result)
				{
					...
					else
					{
						...
						try
						{
							...
							{
								Toast.makeText(User_InfoChange.this, "头像上传失败，请重试！",
										Toast.LENGTH_SHORT).show();
							}
			...
			switch (requestCode)
			{
				...
				case CHOOSE_PICTURE:
					...
					try
					{
						...
						if(Build.VERSION.SDK_INT>= Build.VERSION_CODES.KITKAT)
						{
							exif = new ExifInterface(IOUtils.getPath(User_InfoChange.this, originalUri));
						}
						else
						{
...
public void showPicturePicker(final Context context,boolean isCrop){
	...
	builder =new AlertDialog.Builder(User_InfoChange.this);
...
//	}
			...
			int requestCode)
	{
		...
		String url=getPath(User_InfoChange.this,uri); 
