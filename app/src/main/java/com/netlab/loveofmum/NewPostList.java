...
import com.netlab.loveofmum.myadapter.CHK_NewPostList_Adapter;
 ...
 */
public class NewPostList extends BaseActivity
{
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        {
            Toast.makeText(NewPostList.this, R.string.msgUninternet,
...
//											R.id.item_postlist_txt003,R.id.item_chkdetail_list_txt007 });
                            ...
                            CHK_NewPostList_Adapter adapter = new CHK_NewPostList_Adapter(
                                    NewPostList.this, arrayList);
            ...
            JsonAsyncTask_Info task = new JsonAsyncTask_Info(NewPostList.this,
                    true, doProcess);
